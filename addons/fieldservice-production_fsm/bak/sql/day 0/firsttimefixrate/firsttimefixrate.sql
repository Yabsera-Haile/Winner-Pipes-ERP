   SELECT
    ...
    FROM
        (SELECT
            ...
            "public"."cms_info_model"."customer_distance_category" AS "customer_distance_category",
            extract(epoch
        from
            ("public"."cms_info_model"."call_actual_enddate" - "public"."cms_info_model"."call_log_date"))/3600 AS "Tat",
            "public"."cms_info_model"."product_group" AS "product_group",
            "public"."cms_info_model"."zone" AS "zone"
        FROM
            "public"."cms_info_model"
        WHERE
            {{call_log_date}}) "source"
    WHERE
        (
            (
