...
class Collab(models.Model):
    ...
    def _get_user_avatar(self,email):
        global rcUsername, rcPassword
        self._get_html()
        self._get_credentials()
        payload = {}
        createtoken_endpoint = "%s/api/v1/users.getAvatar?username=opensesame" % (HTML)
        print(".......createtoken_endpoint2.........",createtoken_endpoint)
        admin_data = self._generate_token(rcUsername, rcPassword)
        ...
        # headers = {
        #     'X-Auth-Token': '4g15TBDWKDxzfBnBrrgCMp5hOuvcJ-5LpaeARKSR7zS',
        #     'X-User-Id': '2o9nsZXKoPDEJyxGM',
        # }
        try:
            response = requests.request("GET", createtoken_endpoint, headers=headers, data=payload)
